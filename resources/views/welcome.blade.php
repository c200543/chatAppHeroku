       ...
       <ol class="carousel-indicators">
            ...
            <div class="carousel-inner">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="intro-text">
                                    <h1 class="intro-lead-in animated bounceInLeft">Welcome to </h1>
                                    <h2 class="intro-heading animated bounceInRight">Chat App</h2>
                                    <p class="intro-paragraph animated bounceInRight">Start to chat with your friend.</p>
                                </div>
                                <a href="/login" class="page-scroll btn btn-xl slider-button animated bounceInUp">Start</a>
                            </div>
                        </div>
                    </div>
                    <img style="width:100% !important; max-height: 1000px; height:100%" src="img/backgrounds/header-bg.jpg" alt="slider-image"/>
                ...
                <div class="item">
                    ...
                    <img style="width:100% !important; max-height: 1000px; height:100%" src="img/backgrounds/header-bg-two.jpg" alt="slider-image"/>
                </div>
                    <!-- Controls -->
